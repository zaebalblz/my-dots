function dotsync
    ...
    set WALLPAPERS_SRC "$HOME/Изображения/Wallpapers"

    echo "🚀 Начинаю синхронизацию конфигов..."
    ...
    # Подтягиваем изменения из облака, если они есть
